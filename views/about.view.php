...
<header>
    <?php require 'partial/header_top.php'?>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <img src="assets/frontend/images/about/sign.png" alt="" class="img-fluid">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team-block mb-5 mb-lg-0">
                    <img src="assets/frontend/images/team/1.jpg" alt="" class="img-fluid w-100">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team-block mb-5 mb-lg-0">
                    <img src="assets/frontend/images/team/2.jpg" alt="" class="img-fluid w-100">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team-block mb-5 mb-lg-0">
                    <img src="assets/frontend/images/team/3.jpg" alt="" class="img-fluid w-100">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team-block">
                    <img src="assets/frontend/images/team/4.jpg" alt="" class="img-fluid w-100">
